...
async function renderHomeScoreboard(){
  ...
  el.innerHTML = `
    ...
    <div class="matchup">
      <div class="team-slot">
        ${logoImg(awayLogo, upcoming.away_team, 200)}
      ...
      <div class="team-slot">
        ${logoImg(homeLogo, upcoming.home_team, 200)}
...
async function renderStandings(){
  ...
  el.innerHTML = teams.map(t => `
    <tr>
      <td class="team-name">${logoImg(t.logo_url, t.name, 200)} ${escapeHtml(t.name)} <span style="opacity:.55">(${escapeHtml(t.abbr)})</span></td>
  ...
  el.innerHTML = data.map(r => `
    <div class="card">
      <h3>
        ...
        ${logoImg(logos[(r.team||"").toLowerCase()], r.team, 100)}
        ${escapeHtml(r.team)}
      </h3>
